...
# -*- coding: utf-8 -*-
#
# Tk_Nosy documentation build configuration file, created by
...
release = '0.1.1'  # METADATA_RESET:release = '<<version>>'
...
latex_documents = [
  (master_doc, 'Tk_Nosy.tex', u'Tk_Nosy Documentation',
...
man_pages = [
    (master_doc, 'projectabcxyz', u'Tk_Nosy Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Tk_Nosy', u'Tk_Nosy Documentation',
   author, 'Tk_Nosy', 'One line description of project.',
   'Miscellaneous'),
]
