...
if __name__ == "__main__":
    ...
    metadataD =  {"<<version>>":"0.1.5"}

    render_file( os.path.abspath('./docs/conf.py'), metadataD )
    render_file( os.path.abspath('./setup.py'), metadataD )
    render_file( os.path.abspath('./tk_nosy/__init__.py'), metadataD )
    render_file( os.path.abspath('./tk_nosy/pyterps.py'), metadataD )
    render_file( os.path.abspath('./tk_nosy/main_gui.py'), metadataD )
